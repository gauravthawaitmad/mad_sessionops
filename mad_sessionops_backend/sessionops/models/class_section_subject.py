...
class ClassSectionSubject(models.Model):
    ...
    subject_id = models.ForeignKey("Subject", on_delete=models.PROTECT, db_column="subject_id")
    ...
    def __str__(self) -> str:
        return (
            f"ClassSectionSubject(section={self.class_section_id_id}, subject={self.subject_id_id})"
        )
