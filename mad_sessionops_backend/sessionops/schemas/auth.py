...
class ForgotPasswordSchema(Schema):
    """Request body for POST /api/auth/password/forgot."""
...
class ResetPasswordSchema(Schema):
    """Request body for POST /api/auth/password/reset."""
...
class SetPasswordSchema(Schema):
    """Request body for POST /api/auth/password/set (first-time setup)."""
