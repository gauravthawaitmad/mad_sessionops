      ...
      <Box sx={{ display: 'flex', gap: 2, mb: 1.5 }}>
        <Tooltip title="Active">
          <Box sx={{ textAlign: 'center' }}>
            <Typography sx={{ fontSize: '20px', fontWeight: 700, color: '#16A34A', lineHeight: 1.2 }}>
        ...
        <Tooltip title="Inactive">
          <Box sx={{ textAlign: 'center' }}>
            <Typography sx={{ fontSize: '20px', fontWeight: 700, color: '#D97706', lineHeight: 1.2 }}>
        ...
        <Tooltip title="Removed">
          <Box sx={{ textAlign: 'center' }}>
            <Typography sx={{ fontSize: '20px', fontWeight: 700, color: '#DC2626', lineHeight: 1.2 }}>
