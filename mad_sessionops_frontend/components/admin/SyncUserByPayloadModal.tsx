      ...
      <form onSubmit={handleSubmit}>
        ...
        <DialogContent sx={{ pb: 1 }}>
          <Typography sx={{ fontSize: "12px", color: "#64748B", mb: 2 }}>
            ...
            <Box
              component="span"
              sx={{ fontFamily: "monospace", bgcolor: "#F1F5F9", px: 0.5, borderRadius: "3px" }}
            >
              user_id
            </Box>{" "}
            in the JSON. The{" "}
          ...
          {result && (
            <Box
              sx={{
                mt: 2,
                p: 1.5,
                bgcolor: result.status === "failed" ? "#FEF2F2" : "#F0FDF4",
                borderRadius: "8px",
            ...
            >
              ...
              {result.error_details && (
                <Typography
                  sx={{ fontSize: "11px", color: "#DC2626", mt: 0.5, fontFamily: "monospace" }}
                >
                  {result.error_details}
                </Typography>
              )}
