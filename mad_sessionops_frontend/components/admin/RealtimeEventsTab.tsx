...
export function RealtimeEventsTab() {
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" }}>
      ...
      >
        ...
        <FormControl size="small" sx={{ minWidth: 130 }}>
          ...
          >
            ...
            <MenuItem value="success" sx={{ fontSize: "12px" }}>
              success
            </MenuItem>
            <MenuItem value="partial_success" sx={{ fontSize: "12px" }}>
              partial_success
            </MenuItem>
            <MenuItem value="failed" sx={{ fontSize: "12px" }}>
              failed
            </MenuItem>
            <MenuItem value="skipped_no_change" sx={{ fontSize: "12px" }}>
              skipped_no_change
            </MenuItem>
            <MenuItem value="skipped_stale" sx={{ fontSize: "12px" }}>
              skipped_stale
            </MenuItem>
            <MenuItem value="skipped_role_not_allowed" sx={{ fontSize: "12px" }}>
        ...
        <FormControl size="small" sx={{ minWidth: 120 }}>
          ...
          >
            ...
            <MenuItem value="insert" sx={{ fontSize: "12px" }}>
              insert
            </MenuItem>
            <MenuItem value="update" sx={{ fontSize: "12px" }}>
              update
            </MenuItem>
            <MenuItem value="deactivate" sx={{ fontSize: "12px" }}>
              deactivate
            </MenuItem>
          </Select>
        </FormControl>
        ...
        <FormControl size="small" sx={{ minWidth: 140 }}>
          ...
          >
            ...
            <MenuItem value="manual_admin" sx={{ fontSize: "12px" }}>
              manual_admin
            </MenuItem>
            <MenuItem value="realtime_webhook" sx={{ fontSize: "12px" }}>
              realtime_webhook
            </MenuItem>
            <MenuItem value="cron_fallback" sx={{ fontSize: "12px" }}>
              cron_fallback
            </MenuItem>
          </Select>
        </FormControl>
        ...
        <TextField
          ...
          onChange={(e) =>
            setFilters({ ...filters, user_id_from_source: e.target.value.replace(/\D/g, "") })
          }
        ...
        <Button
          ...
          variant="outlined"
          startIcon={
            refreshing ? <CircularProgress size={11} color="inherit" /> : <RefreshCw size={11} />
          }
      ...
      {/* ── Modals ──────────────────────────────────────────────────────────── */}
      <RealtimeEventDetail logId={selectedLogId} onClose={() => setSelectedLogId(null)} />
