  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.25 }}>
        ...
        >
          <Typography sx={{ fontSize: '11px', fontWeight: 600, color: '#16A34A', whiteSpace: 'nowrap' }}>
            {scs.subjectName}
          </Typography>
        </Box>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
          ...
          {!canModify && slotClasses.length === 0 && (
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 1, py: 2.5 }}>
              ...
              <Typography sx={{ fontSize: '12px', color: MUTED }}>No classes assigned yet.</Typography>
            </Box>
          )}
        </Box>
      )}
