...
import {
  addChildToBucket,
  removeChildFromBucket,
  type BucketItem,
} from "@/lib/api/services/buckets.service";
...
export function ManageBucketChildrenModal({
  ...
  return (
    <Dialog
      ...
      PaperProps={{
        sx: { borderRadius: "14px", boxShadow: "0 20px 60px rgba(0,0,0,0.12)", maxHeight: "85vh" },
      }}
    >
      {/* Header */}
      <DialogTitle
      ...
      <DialogContent sx={{ px: 3, py: 2, overflowY: "auto" }}>
        ...
        <TextField
          ...
          InputProps={{
            startAdornment: <Search size={14} style={{ marginRight: 6, color: TEXT_MUTED }} />,
          }}
