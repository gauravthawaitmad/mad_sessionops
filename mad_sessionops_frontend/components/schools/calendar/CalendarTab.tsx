      ...
      <Box sx={{ display: "flex", alignItems: "center", gap: 2, flexWrap: "wrap", minHeight: 36 }}>
        ...
        {active && (
          ...
          >
            ...
            <Typography sx={{ fontSize: "11px", fontWeight: 600, color: "#15803D" }}>
              Active
            </Typography>
          </Box>
        )}
        ...
        {!active && !upcoming && (
          ...
          >
            <Typography sx={{ fontSize: "11px", fontWeight: 600, color: colors.gray[500] }}>
              Completed
            </Typography>
          </Box>
        )}
      ...
      {active && (
        <Box sx={{ mt: 1.5 }}>
          <Box sx={{ display: "flex", justifyContent: "space-between", mb: 0.5 }}>
            <Typography sx={{ fontSize: "10px", color: colors.gray[400] }}>
              Session progress
            </Typography>
            <Typography sx={{ fontSize: "10px", fontWeight: 600, color: colors.primary[600] }}>
              {pct}%
            </Typography>
          </Box>
          <Box
            sx={{ height: 5, bgcolor: colors.gray[100], borderRadius: "99px", overflow: "hidden" }}
          >
            <Box
              sx={{
                height: "100%",
...
export function CalendarTab({ schoolId }: CalendarTabProps) {
  ...
  if (error) {
    return (
      ...
      >
        ...
        <Typography
          sx={{ fontSize: "14px", color: colors.gray[600], textAlign: "center", maxWidth: 320 }}
        >
          {error}
        </Typography>
      </Box>
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", flex: 1 }}>
      ...
      {/* Month grid */}
      <CalendarMonthGrid session={session} holidays={holidays} onHolidayClick={setEditingHoliday} />
      ...
      <DeleteHolidayModal
        ...
        onDeleted={(id) => {
          setHolidays((prev) => prev.filter((h) => h.schoolHolidayId !== id));
