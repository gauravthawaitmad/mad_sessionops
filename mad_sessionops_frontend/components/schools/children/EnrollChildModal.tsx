          ...
          return (
            <Box
              ...
              sx={{
                ...
                borderRight: i < GENDER_OPTS.length - 1
                  ? `1px solid ${active ? o.color : BORDER}`
                  : 'none',
              ...
              >
                ...
                <LinearProgress
                  ...
                  sx={{
                    ...
                    mb: 0.5,
                    bgcolor: '#E2E8F0',
                    '& .MuiLinearProgress-bar': { bgcolor: selected ? '#2563EB' : color, borderRadius: 2 },
                  }}
                />
...
export function EnrollChildModal({ open, schoolId, onClose, onSuccess }: EnrollChildModalProps) {
  ...
  const {
    ...
    defaultValues: {
      ...
      city: '', mother_tongue: '',
      date_of_birth: '', date_of_enrollment: '', mad_joining_date: '',
    },
  });
