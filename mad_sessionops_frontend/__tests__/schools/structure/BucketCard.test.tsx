...
describe('BucketCard — UX polish', () => {
  ...
  it('test_renders_display_name_and_count_badge', () => {
    render(
      <BucketCard bucket={MOCK_BUCKET} schoolId={580} onUpdated={noop} onRemoved={noop} />
    );
  ...
  it('test_avatar_stack_shows_roster_preview', () => {
    ...
    render(
      <BucketCard bucket={MOCK_BUCKET} schoolId={580} roster={roster} onUpdated={noop} onRemoved={noop} />
    );
  ...
  it('test_avatar_stack_shows_overflow_count', () => {
    ...
    render(
      <BucketCard bucket={{ ...MOCK_BUCKET, activeChildrenCount: 5 }} schoolId={580} roster={roster} onUpdated={noop} onRemoved={noop} />
    );
  ...
  it('test_delete_enabled_when_bucket_is_empty', async () => {
    render(
      <BucketCard bucket={EMPTY_BUCKET} schoolId={580} onUpdated={noop} onRemoved={noop} />
    );
  ...
  it('test_menu_hidden_when_cannot_modify', () => {
    render(
      <BucketCard bucket={MOCK_BUCKET} schoolId={580} canModify={false} onUpdated={noop} onRemoved={noop} />
    );
