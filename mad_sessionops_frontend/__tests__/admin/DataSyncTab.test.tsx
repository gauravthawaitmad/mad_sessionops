...
const mockTriggerEntitySync = vi
  .fn()
  .mockResolvedValue({ userRunId: 10, partnerRunId: null, partnerWorknodeRunId: null });
...
describe("DataSyncTab — per-entity sync", () => {
  beforeEach(() => {
    ...
    mockTriggerEntitySync.mockResolvedValue({
      userRunId: 10,
      partnerRunId: null,
      partnerWorknodeRunId: null,
    });
  });
